<?php
include('imagen/image.php');
 //include(APPPATH.'third_party/php_codi_barra/imagen/image.php');
//include_once APPPATH.'third_party/php_codi_barra/imagen/image.php';
class phpCode128 {
	...
	function setImageWidth($pixels) {
		...
		$this->image = new imagen($this->getImageWidth(), $this->getImageHeight());
		if($this->font <> false) {
