...
$('.text').typed({
  strings: [
    "¡Vaya! Parece que estás perdido.. <br /> ^1000" +
    "Lo siento por eso. <br /> ^1000" +
    "Dejame Ayudarte <br /> ^1000" +
    "Regresa al <a href='<?php  echo base_url() ;?>'>INICIO</a> y relaliza las operaciones que tengas que hacer"
  ],
  typeSpeed: 0,
  showCursor: false
});
