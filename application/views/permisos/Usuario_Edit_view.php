          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6" style="text-align:center">
                <?php if(isset($usuario['RUTIMAGEN'])) { ?>
                  <img src="<?php echo $this->config->item('ip').$usuario['RUTIMAGEN']; ?>" alt="IMAGEN USUARIO" style="width:40%">
                <?php } ?>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input name="UserNombre" id='UserNombre' value="<?php echo $usuario['NNOMBRE']; ?>" type="text" class="form-control" required="">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  DIRECCIÓN <span class="text-red">*</span>
                    <input name="UserDireccion" id='UserDireccion' value="<?php  echo $usuario['NDIRECC']; ?>" type="text" class="form-control" >
            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                  CELULAR
                    <input name="UserCelular" id='UserCelular' value="<?php  echo $usuario['NTELEFO']; ?>" type="number" class="form-control">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  DNI <span class="text-red">*</span>
                    <input name="UserDni" id='UserDni' value="<?php  echo $usuario['NDNI']; ?>" data-minlength="8" type="number" class="form-control"  onKeyUp="return limitar(event,this.value,8)" onKeyDown="return limitar(event,this.value,8)"  required="">
            ...
            <div class="row">
              <div class="col-md-6">
                  ...
                  USUARIO <span class="text-red">*</span>
                    <input name="UserLogin" id='UserLogin' value="<?php  echo $usuario['LOGIN']; ?>" type="text" class="form-control" required="">
                </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                  CONTRASEÑA <span class="text-red">*</span> <a class="pull-right" onclick="editar_psw()" data-toggle="tooltip" title="EDITAR CONTRASEÑA"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                    <input name="UserPsw" id='UserPsw' value="<?php echo $usuario['NCLAVE']; ?>" type="password" class="form-control" readonly="">
                </div>
              </div>
            </div>
            <div class="row">
                  ...
                  OFICINA <span class="text-red">*</span>
                    <select class="form-control" id='oficina' name="oficina" onchange="get_areas()">
                      <?php foreach ($oficinas as $ofi) { ?>
                        <option value="<?php echo $ofi['OFICOD']; ?>" <?php echo (($usuario['OFICOD'] == $ofi['OFICOD']) ?  "selected" : ""); ?> ><?php echo $ofi['OFIDES']; ?></option>
                      <?php } ?>
                    </select>
                </div>
                  ...
                  AREA <span class="text-red">*</span>
                    <select class="form-control" id='areas' name="area" required="">
                      <?php foreach ($areas as $area) { ?>
                        <option value="<?php echo $area['OFIAGECOD']; ?>" <?php echo (($usuario['OFIAGECOD'] == $area['OFIAGECOD']) ? "selected" : "" ); ?>> <?php echo $area['OFIAGEDES']; ?> </option>
                      <?php } ?>
                    </select>
                </div>
              </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="estado">
                    <?php foreach ($estados as $estado) { ?>
                      <option value="<?php echo $estado['ID_ESTADOS']; ?>" <?php echo (($usuario['NESTADO'] == $estado['ID_ESTADOS']) ? "selected" : "" ) ?>><?php echo $estado['ESTNOMBRE']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id='fechaInicio' name="fechaInicio" class="form-control" value="<?php echo $usuario['NFECHAE'] ?>" readonly="">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id='fechaFin' name="fechaFin" value="<?php echo $usuario['NENDS'] ?>" required="">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" name="rol" id='roles'>
                    ...
                    <?php foreach ($roles as $rol) { ?>
                      <option value="<?php echo $rol['ID_ROL']; ?>" <?php echo  (($rol1['ID_ROL'] == $rol['ID_ROL']) ? "class='text-red'" : "") ;?> <?php echo  (($rol1['ID_ROL'] == $rol['ID_ROL']) ? "selected" : ""); ?> ><?php echo $rol['ROLDESC']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
