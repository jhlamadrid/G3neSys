                    ...
                    <div class="row">
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="TABPROFORMA">
                            <li role="presentation" class="active">
                                <a href="#extorno" aria-controls="Comprobantes" role="tab" data-toggle="tab">
                                    <h4>EXTORNAR</h4> 
                                </a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="extorno">
                                <div class="container-fluid">
                                    <br>
                                            ...
                                            <?php foreach ($pagados as $bf) { ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center">
                                                        <?php if($bf['GENERADO'] == 1){?>
                                                            <span class="label label-primary">Permiso generado</span>
                                                        <?php }else{?>
                                                        <a class="btn btn-default btn-flat btn-sm" data-toggle="tooltip" data-placement="bottom" title="Pagar" href="<?php echo $this->config->item('ip').'financiamiento/detalle_extorno/'.$bf['OFICOD'].'/'.$bf['OFIAGECOD'].'/'.$bf['CREDNRO']; ?>">
                                                            Extornar
                                                        </a>
                                                        <?php }?>
                                                    </td>
