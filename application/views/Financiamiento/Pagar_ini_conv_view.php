        ...
        <div class="col-md-12">
            ...
            <div class="box  box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo $titulo.'-'.$_SESSION['user_id'].'-'.$_SESSION['OFICOD'].'-'.$_SESSION['OFIAGECOD']; ?></h3>
                </div>
                <div class="box-body ">  
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    ...
                                                    <?php if($comprobante['EST_PAGO']==1) { ?>
                                                        <span class="label label-info">Emitido</span>
                                                    <?php } else { ?>
                                                        <a class="btn btn-default btn-flat btn-sm" data-toggle="tooltip" data-placement="bottom" title="Pagar" href="<?php echo $this->config->item('ip').'financiamiento/mostrar_inicial/'.$comprobante['OFICOD'].'/'.$comprobante['OFIAGECOD'].'/'.$comprobante['CREDNRO'].'/1'; ?>">
                                                            Pagar
                                                        </a>
                                                    <?php } ?>
                                                </td>
                            ...
                            <div role="tabpanel" class="tab-pane" id="boletas_facturas">
                                <div class="container-fluid">
                                    ...
                                    <table id="comprobantes" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($pagados as $bf) { ?>
                                                <tr>
                                                    <td><?php echo $bf['FECHA']; ?></td>
                                                    <td>
                                                        <?php echo $bf['CREDNRO']; ?>
                                                    </td>
                                                    <td><?php echo $bf['CLICODFAC']; ?></td>
                                                    <td><?php echo $bf['OFICOD'].'-'.$bf['OFIAGECOD']; ?></td>
                                                    <td>
                                                        <?php echo ($bf['REPSOLNOM']!= NULL)? $bf['REPSOLNOM'] : $bf['SOLICINOM']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo ($bf['REPSOLDNI']!= NULL)? $bf['REPSOLDNI'] : $bf['SOLICIDNI']; ?>
                                                    </td>
                                                    <td style="text-align:right;">
                                                        <?php echo number_format($bf['INICIAL'],2); ?>
                                                    </td>
                                                    <td style="text-align:center">
                                                        <a class="btn btn-default btn-flat" onclick="imprimir_copia(<?php echo $bf['OFICOD'].', '.$bf['OFIAGECOD'].', '.$bf['CREDNRO'];?>)">
