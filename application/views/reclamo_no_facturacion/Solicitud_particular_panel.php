    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title text-uppercase text-info titulo_box" style="font-family:Ubuntu">Reclamos de Alcance Particular </h3>
                <?php if($_SESSION['accesoReclamos'] != null && $_SESSION['accesoReclamos']['ARECOD'] != null) {?>
                    <a class="btn btn-success pull-right" href="<?php echo $this->config->item('ip')?>relativo_no_facturacion/solicitud_particular/nuevo">Nueva Solicitud</a>
                <?php } ?>
            </div>
            <div class="box-body">
                <div class="row">
