                ...
                <div class="col-md-10 col-offset-1">
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h4 class="text-center" id="titulo">DETALLE DE ATIPICO FACTURACION DE <?php echo $periodo."-".$anio;?></h4>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="row">
                            ...
                            <div class="row">
                                <div class='list-group gallery'>
                                    ...
                                    while (count($detalle_atipico)>$i) {
                                       $j= 0;
                                       while (count($detalle_atipico[$i])>$j) {

                                            $nombre = explode('/', $detalle_atipico[$i][$j]['ruta_img']); 
                                    ?>

                                    <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                        <a class="thumbnail fancybox" rel="ligthbox" href="<?php echo $this->config->item('externalIP').$detalle_atipico[$i][$j]['ruta_img']; ?>">
                                            <img class="img-responsive"   alt=""  src="<?php echo $this->config->item('externalIP').$detalle_atipico[$i][$j]['ruta_img']; ?>" />
                                            <div class='text-right'>
                                                <small class='text-muted'><?php echo $nombre[6]; ?></small>
                                            </div> <!-- text-right / end -->
                                        </a>
                                    </div> <!-- col-6 / end -->
                                    <?php   
                                    ...
                                    <div class="col-md-12" style="margin-top: 15px;">
                                            <div class="col-xs-5">
                                                ...
                                                ?>
                                                        ...
                                                        <option value="<?php  echo $this->config->item('externalIP').$detalle_atipico[$i][$j]['ruta_img']; ?>"> <?php echo $nombre[6];?> </option>
                                                <?php
                                                        $j++;
                                                    }
                                                    $i++;
                            ...
                            <div class="row">
                                <div class="col-md-4 " style="margin-top: 15px;">
                                    <button class= 'btn btn-md btn-primary' id="Imp_boton"  style="width: 100%;">Imprimir Imagene(s) </button>    
                                </div>
                                <div class="col-md-4" style="margin-top: 15px;">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#search').multiselect({
                search: {
                    left: '<input type="text" name="q" class="form-control" placeholder="Escoger Imagen" />',
                    right: '<input type="text" name="q" class="form-control" placeholder="Escoger Imagen" />',
                },
