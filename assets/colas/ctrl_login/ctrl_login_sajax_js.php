  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_ctrl_login" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate usuario
  function do_ajax_ctrl_login_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ctrl_login_validate_usuario(var_usuario, var_script_case_init, do_ajax_ctrl_login_validate_usuario_cb);
  } // do_ajax_ctrl_login_validate_usuario

  function do_ajax_ctrl_login_validate_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ctrl_login_validate_usuario_cb

  // ---------- Validate sc_field_0
  function do_ajax_ctrl_login_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ctrl_login_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_ctrl_login_validate_sc_field_0_cb);
  } // do_ajax_ctrl_login_validate_sc_field_0

  function do_ajax_ctrl_login_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ctrl_login_validate_sc_field_0_cb
  // ---------- Form
  function do_ajax_ctrl_login_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_ctrl_login_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_ctrl_login_submit_form(var_usuario, var_sc_field_0, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_ctrl_login_submit_form_cb);
  } // do_ajax_ctrl_login_submit_form

  function do_ajax_ctrl_login_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_ctrl_login_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_ctrl_login_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_ctrl_login_navigate_form

  function do_ajax_ctrl_login_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_ctrl_login_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_ctrl_login_navigate_form_cb
  function sc_hide_ctrl_login_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_ctrl_login_form
