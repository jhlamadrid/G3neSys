...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>ctrl_login/ctrl_login_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("ctrl_login_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('ctrl_login_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['recarga'];
}
?>
...
<?php
 include_once("ctrl_login_mob_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['ctrl_login_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['ctrl_login_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_usuario_line" id="hidden_field_data_usuario" style="<?php echo $sStyleHidden_usuario; ?>"> <span class="scFormLabelOddFormat css_usuario_label"><span id="id_label_usuario"><?php echo $this->nm_new_label['usuario']; ?></span></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['sc_field_0'] = "contraseña";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { ?>
<span id="id_read_on_sc_field_0" class="sc-ui-readonly-sc_field_0 css_sc_field_0_line" style="<?php echo $sStyleReadLab_sc_field_0; ?>"><?php echo $this->form_encode_input($this->sc_field_0); ?></span><span id="id_read_off_sc_field_0" style="white-space: nowrap;<?php echo $sStyleReadInp_sc_field_0; ?>">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['ctrl_login_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("ctrl_login_mob");
 parent.scAjaxDetailHeight("ctrl_login_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
