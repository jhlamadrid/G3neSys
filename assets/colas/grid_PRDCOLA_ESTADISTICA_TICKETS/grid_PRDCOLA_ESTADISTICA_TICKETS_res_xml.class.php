...
class grid_PRDCOLA_ESTADISTICA_TICKETS_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_export']['data'];
      $contr_rowspan = array();
      $tit_rowspan   = array();
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          $lab           = "";
          $cmp           = false;
          $xml_registro  = "<grid_PRDCOLA_ESTADISTICA_TICKETS";
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
              {
