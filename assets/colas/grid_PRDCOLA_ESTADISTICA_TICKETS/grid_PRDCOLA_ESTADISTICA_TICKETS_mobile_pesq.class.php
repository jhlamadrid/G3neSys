...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "cdatecodcola";$Nm_datas[] = "tickfecgen";$Nm_datas[] = "tickfecate";$Nm_numeric[] = "oficodcola";$Nm_numeric[] = "mvtncod";$Nm_numeric[] = "ticknro";$Nm_numeric[] = "usrcodcola";$Nm_numeric[] = "tickdurateseg";$Nm_numeric[] = "tickduratemin";$Nm_numeric[] = "";
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_cdatecodcola"  <?php echo $str_hide_cdatecodcola?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<INPUT type="hidden" id="sc_cdatecodcola_jq">
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_cdatecodcola"  <?php echo $str_display_cdatecodcola; ?> class="scFilterFieldFontOdd">
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_oficodcola"  <?php echo $str_hide_oficodcola?>>
<?php
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_mvtnabr"  <?php echo $str_hide_mvtnabr?>><?php
      $mvtnabr_look = substr($this->Db->qstr($mvtnabr), 1, -1); 
      $nmgp_def_dados = array(); 
