...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "FECHA";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_label_graf']['cdatecodcola']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_label_graf']['cdatecodcola']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_label_graf']['cdatecodcola'];
      }
   }
