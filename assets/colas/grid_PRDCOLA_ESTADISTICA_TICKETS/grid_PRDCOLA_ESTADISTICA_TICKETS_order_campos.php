<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_PRDCOLA_ESTADISTICA_TICKETS_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_PRDCOLA_ESTADISTICA_TICKETS_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['oficodcola'] = "on";
   $tab_def_campos['oficodcola'] = "OFICODCOLA";
   $tab_converte["OFICODCOLA"]   = "oficodcola";
   $tab_labels["oficodcola"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["oficodcola"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["oficodcola"] : "OFICINA";
   $tab_ger_campos['usrnom'] = "on";
   $tab_def_campos['usrnom'] = "USRNOM";
   $tab_converte["USRNOM"]   = "usrnom";
   $tab_labels["usrnom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["usrnom"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["usrnom"] : "Atendido por";
   $tab_ger_campos['mvtnabr'] = "on";
   $tab_def_campos['mvtnabr'] = "MVTNABR";
   $tab_converte["MVTNABR"]   = "mvtnabr";
   $tab_labels["mvtnabr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["mvtnabr"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["mvtnabr"] : "MVTNABR";
   $tab_ger_campos['cdatecodcola'] = "on";
   $tab_def_campos['cdatecodcola'] = "CDATECODCOLA";
   $tab_converte["CDATECODCOLA"]   = "cdatecodcola";
   $tab_labels["cdatecodcola"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["cdatecodcola"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["cdatecodcola"] : "FECHA";
   $tab_ger_campos['ticknro'] = "on";
   $tab_def_campos['ticknro'] = "TICKNRO";
   $tab_converte["TICKNRO"]   = "ticknro";
   $tab_labels["ticknro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["ticknro"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["ticknro"] : "TICKNRO";
   $tab_ger_campos['tickhoragen'] = "on";
   $tab_def_campos['tickhoragen'] = "TICKHORAGEN";
   $tab_converte["TICKHORAGEN"]   = "tickhoragen";
   $tab_labels["tickhoragen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tickhoragen"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tickhoragen"] : "Hora de Generac";
   $tab_ger_campos['tickhorate'] = "on";
   $tab_def_campos['tickhorate'] = "TICKHORATE";
   $tab_converte["TICKHORATE"]   = "tickhorate";
   $tab_labels["tickhorate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tickhorate"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tickhorate"] : "Usuario";
   $tab_ger_campos['tickhoratefin'] = "on";
   $tab_def_campos['tickhoratefin'] = "TICKHORATEFIN";
   $tab_converte["TICKHORATEFIN"]   = "tickhoratefin";
   $tab_labels["tickhoratefin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tickhoratefin"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tickhoratefin"] : "Fin Atencion";
   $tab_ger_campos['tickduratemin'] = "on";
   $tab_def_campos['tickduratemin'] = "TICKDURATEMIN";
   $tab_converte["TICKDURATEMIN"]   = "tickduratemin";
   $tab_labels["tickduratemin"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tickduratemin"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tickduratemin"] : "Durac Minutos";
   $tab_ger_campos['espera_usuario'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['espera_usuario'] = "espera_usuario";
       $tab_converte["espera_usuario"]   = "espera_usuario";
   }
   else
   {
       $tab_def_campos['espera_usuario'] = "";
       $tab_converte[""]   = "espera_usuario";
   }
   $tab_labels["espera_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["espera_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["espera_usuario"] : "Espera del Usuario";
   $tab_ger_campos['tiempo_muerto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['tiempo_muerto'] = "tiempo_muerto";
       $tab_converte["tiempo_muerto"]   = "tiempo_muerto";
   }
   else
   {
       $tab_def_campos['tiempo_muerto'] = "";
       $tab_converte[""]   = "tiempo_muerto";
   }
   $tab_labels["tiempo_muerto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tiempo_muerto"])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']["tiempo_muerto"] : "Perm Usuario";
   $tab_ger_campos['espera_usuario'] = "none";
   $tab_ger_campos['tiempo_muerto'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_PRDCOLA_ESTADISTICA_TICKETS_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
