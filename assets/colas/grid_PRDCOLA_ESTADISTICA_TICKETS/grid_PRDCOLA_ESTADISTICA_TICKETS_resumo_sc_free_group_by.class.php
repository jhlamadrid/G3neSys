...
class grid_PRDCOLA_ESTADISTICA_TICKETS_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_oficodcola;
   var $array_total_cdatecodcola;
   var $array_total_tickabr;
   var $array_total_usrcodcola;
   ...
   function grid_PRDCOLA_ESTADISTICA_TICKETS_resumo($tipo = "")
   {
      ...
      $this->array_total_oficodcola   = array();
      $this->array_total_cdatecodcola = array();
      $this->array_total_tickabr      = array();
      $this->array_total_usrcodcola   = array();
...
$_SESSION['scriptcase']['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_total_geral'] == "OK")
      {
          ...
          $this->array_total_oficodcola = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_total']['oficodcola'];
          ...
          $this->array_total_tickabr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_total']['tickabr'];
          $this->array_total_usrcodcola = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_total']['usrcodcola'];
      }
      else
      {
          $this->array_total_oficodcola = array();
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['oficodcola'] = "OFICINA";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels'][''] = "OFICINA"; 
       $prep_field['cdatecodcola'] = "FECHA";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels'][''] = "FECHA"; 
       $prep_field['tickabr'] = "TIPO TICKET";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels'][''] = "TIPO TICKET"; 
       $prep_field['usrcodcola'] = "Usuario";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels'][''] = "Usuario"; 
       $Str_gb = "";
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['oficodcola']['alin'] = "''";
       $Arr_parms['oficodcola']['link'] = "S";
       $Arr_parms['cdatecodcola']['alin'] = "''";
       $Arr_parms['cdatecodcola']['link'] = "S";
       $Arr_parms['tickabr']['alin'] = "''";
       $Arr_parms['tickabr']['link'] = "S";
       $Arr_parms['usrcodcola']['alin'] = "''";
       $Arr_parms['usrcodcola']['link'] = "S";
       $Arr_parms['oficodcola']['fill'] = "true";
       $Arr_parms['oficodcola']['order'] = "label";
       $Arr_parms['cdatecodcola']['fill'] = "true";
       $Arr_parms['cdatecodcola']['order'] = "value";
       $Arr_parms['tickabr']['fill'] = "true";
       $Arr_parms['tickabr']['order'] = "label";
       $Arr_parms['usrcodcola']['fill'] = "true";
       $Arr_parms['usrcodcola']['order'] = "label";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['oficodcola'] = array(0 => 'oficodcola', 1 => '');
       $prep_links_fl['cdatecodcola'] = array(0 => 'cdatecodcola', 1 => '@aspass@');
       $prep_links_fl['tickabr'] = array(0 => 'tickabr', 1 => '@aspass@');
       $prep_links_fl['usrcodcola'] = array(0 => 'usrcodcola', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_order_col'] = 1;
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_order_sort'] = 'd';
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("OFICINA")),
           ...
           '0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("TIPO TICKET")),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(0),
           ),
           '1' => array(
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      ...
      $this->array_total_tickabr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_total']['tickabr'];
      $this->array_total_usrcodcola = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_total']['usrcodcola'];
      ksort($this->array_total_oficodcola);
      ksort($this->array_total_cdatecodcola);
      ksort($this->array_total_tickabr);
      ksort($this->array_total_usrcodcola);
   }
...
{ 
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_tiempo_muerto, $avg_tiempo_muerto, $quebra_oficodcola, $quebra_cdatecodcola, $quebra_tickabr, $quebra_usrcodcola, $quebra_oficodcola_orig, $quebra_cdatecodcola_orig, $quebra_tickabr_orig, $quebra_usrcodcola_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (empty($sum_tiempo_muerto)) {$sum_tiempo_muerto = '0';}
          if (empty($avg_tiempo_muerto)) {$avg_tiempo_muerto = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_tiempo_muerto . ';
              $this->' . $arr_name . '[2] = ' . $avg_tiempo_muerto . ';
              $this->' . $arr_name . '[3] = "' . $$cmp_look . '";
   ...
   function compat_arrays()
   {
      ...
      {
          $Arr_gb[]   = $cmp_gb;
          $Arr_name[] = "_SESSION['sc_session'][" . $this->Ini->sc_page . "]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_total']['" .$cmp_gb . "']" . $Control;
   ...
   function finaliza_arrays()
   {
      ...
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
          $Str_gb .= "foreach (\$this->" . $Arr_name[$ix] . " as \$campo_" . $Arr_gb[$ix] . " => \$dados_" . $Arr_gb[$ix] . ")";
          $Str_gb .= "{";
          $Str_gb .=     "if (\$this->" . $Arr_name[$ix] . "[\$campo_" . $Arr_gb[$ix] . "][0] != 0) {\$this->" . $Arr_name[$ix] . "[\$campo_" . $Arr_gb[$ix] . "][2] /= \$this->" . $Arr_name[$ix] . "[\$campo_" . $Arr_gb[$ix] . "][0];}";
      }
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
          $Str_gb .= "}";
...
$_SESSION['scriptcase']['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->tiempo_muerto, $this->tiempo_muerto, $this->oficodcola, $this->cdatecodcola, $this->tickabr, $this->usrcodcola, $this->oficodcola_orig,  $this->cdatecodcola_orig,  $this->tickabr_orig,  $this->usrcodcola_orig);
            }
   }
//
