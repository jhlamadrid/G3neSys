...
class grid_PRDCOLA_ESTADISTICA_TICKETS_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_PRDCOLA_ESTADISTICA_TICKETS_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_PRDCOLA_ESTADISTICA_TICKETS_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_PRDCOLA_ESTADISTICA_TICKETS_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_PRDCOLA_ESTADISTICA_TICKETS_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_mvtnabr')
      {
          $mvtnabr = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_mvtnabr($mvtnabr);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_mvtnabr($mvtnabr)
   {
      $mvtnabr = substr($this->Db->qstr($mvtnabr), 1, -1);
            $mvtnabr_look = substr($this->Db->qstr($mvtnabr), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct MVTNABR from " . $this->Ini->nm_tabela . " where  MVTNABR like '%" . $mvtnabr . "%'"; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "oficodcola";$Nm_numeric[] = "mvtncod";$Nm_numeric[] = "ticknro";$Nm_numeric[] = "usrcodcola";$Nm_numeric[] = "tickdurateseg";$Nm_numeric[] = "tickduratemin";$Nm_numeric[] = "";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "cdatecodcola";$Nm_datas[] = "tickfecgen";$Nm_datas[] = "tickfecate";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         $nome_sum = "PRDCOLA.ESTADISTICA_TICKETS.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Estadistica de Atención al Cliente</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_PRDCOLA_ESTADISTICA_TICKETS/grid_PRDCOLA_ESTADISTICA_TICKETS_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_PRDCOLA_ESTADISTICA_TICKETS_ajax_search.js"></script>
 <script type="text/javascript" src="grid_PRDCOLA_ESTADISTICA_TICKETS_ajax.js"></script>
 <script type="text/javascript">
...
function scJQCalendarAdd() {
  $("#sc_cdatecodcola_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_cdatecodcola_dia').value + '/';
          var_dt_ini += document.getElementById('SC_cdatecodcola_mes').value + '/';
          var_dt_ini += document.getElementById('SC_cdatecodcola_ano').value;
          document.getElementById('sc_cdatecodcola_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_cdatecodcola_dia').value = aParts[0];
          document.getElementById('SC_cdatecodcola_mes').value = aParts[1];
          document.getElementById('SC_cdatecodcola_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_cdatecodcola_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_cdatecodcola_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_cdatecodcola_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_cdatecodcola_input_2_ano').value;
          document.getElementById('sc_cdatecodcola_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_cdatecodcola_input_2_dia').value = aParts[0];
          document.getElementById('SC_cdatecodcola_input_2_mes').value = aParts[1];
          document.getElementById('SC_cdatecodcola_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cdatecodcola_cond#NMF#' + search_get_sel_txt('SC_cdatecodcola_cond') + '@NMF@';
  str_out += 'SC_cdatecodcola_dia#NMF#' + search_get_sel_txt('SC_cdatecodcola_dia') + '@NMF@';
  str_out += 'SC_cdatecodcola_mes#NMF#' + search_get_sel_txt('SC_cdatecodcola_mes') + '@NMF@';
  str_out += 'SC_cdatecodcola_ano#NMF#' + search_get_sel_txt('SC_cdatecodcola_ano') + '@NMF@';
  str_out += 'SC_cdatecodcola_input_2_dia#NMF#' + search_get_sel_txt('SC_cdatecodcola_input_2_dia') + '@NMF@';
  str_out += 'SC_cdatecodcola_input_2_mes#NMF#' + search_get_sel_txt('SC_cdatecodcola_input_2_mes') + '@NMF@';
  str_out += 'SC_cdatecodcola_input_2_ano#NMF#' + search_get_sel_txt('SC_cdatecodcola_input_2_ano') + '@NMF@';
  str_out += 'SC_oficodcola_cond#NMF#' + search_get_sel_txt('SC_oficodcola_cond') + '@NMF@';
  str_out += 'SC_oficodcola#NMF#' + search_get_checkbox('SC_oficodcola') + '@NMF@';
  str_out += 'SC_mvtnabr_cond#NMF#' + search_get_sel_txt('SC_mvtnabr_cond') + '@NMF@';
  str_out += 'SC_mvtnabr#NMF#' + search_get_text('SC_mvtnabr') + '@NMF@';
  str_out += 'id_ac_mvtnabr#NMF#' + search_get_text('id_ac_mvtnabr') + '@NMF@';
   ...
   $("#id_ac_mvtnabr").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_mvtnabr",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_mvtnabr").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_mvtnabr").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Estadistica de Atención al Cliente</span></td>
...
<?php
   ...
   {
      global 
             $cdatecodcola_cond, $cdatecodcola, $cdatecodcola_dia, $cdatecodcola_mes, $cdatecodcola_ano, $cdatecodcola_input_2_dia, $cdatecodcola_input_2_mes, $cdatecodcola_input_2_ano,
             $oficodcola_cond, $oficodcola,
             $mvtnabr_cond, $mvtnabr, $mvtnabr_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cdatecodcola_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_dia']; 
          $cdatecodcola_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_mes']; 
          $cdatecodcola_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_ano']; 
          $cdatecodcola_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_input_2_dia']; 
          $cdatecodcola_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_input_2_mes']; 
          $cdatecodcola_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_input_2_ano']; 
          $cdatecodcola_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_cond']; 
          $oficodcola = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['oficodcola']; 
          $oficodcola_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['oficodcola_cond']; 
          $mvtnabr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['mvtnabr']; 
          $mvtnabr_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['mvtnabr_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['NM_operador']; 
      } 
      if (!isset($cdatecodcola_cond) || empty($cdatecodcola_cond))
      {
         $cdatecodcola_cond = "bw";
      }
      if (!isset($oficodcola_cond) || empty($oficodcola_cond))
      {
         $oficodcola_cond = "eq";
      }
      if (!isset($mvtnabr_cond) || empty($mvtnabr_cond))
      {
         $mvtnabr_cond = "eq";
      }
      ...
      $str_hide_cdatecodcola = (in_array($cdatecodcola_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_oficodcola = (in_array($oficodcola_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_mvtnabr = (in_array($mvtnabr_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_cdatecodcola = ('bw' == $cdatecodcola_cond) ? $display_aberto : $display_fechado;

      // oficodcola
      if (is_array($oficodcola) && !empty($oficodcola))
      {
         $tmp_array = array();
         $oficodcola_val_str = "";
         foreach ($oficodcola as $tmp_val_cmp)
         {
            if ("" != $oficodcola_val_str)
            {
               $oficodcola_val_str .= ", ";
            }
            ...
            $oficodcola_val_str .= "'$tmp_val_cmp'";
         }
         $oficodcola = $tmp_array;
      }
      else
      {
         $oficodcola_val_str = "";
      }
      if (!isset($cdatecodcola) || $cdatecodcola == "")
      {
          $cdatecodcola = "";
      }
      if (isset($cdatecodcola) && !empty($cdatecodcola))
      {
      ...
      if (!isset($oficodcola) || $oficodcola == "")
      {
          $oficodcola = array();
      }
      if (!isset($mvtnabr) || $mvtnabr == "")
      {
          $mvtnabr = "";
      }
      if (isset($mvtnabr) && !empty($mvtnabr))
      {
...
<?php
   if (is_file("grid_PRDCOLA_ESTADISTICA_TICKETS_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cdatecodcola'])) ? $this->New_label['cdatecodcola'] : "FECHA"; ?> <span class="scFilterRequiredOdd">*</span></TD>
      
      <INPUT type="hidden" id="SC_cdatecodcola_cond" name="cdatecodcola_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cdatecodcola" <?php echo $str_hide_cdatecodcola?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cdatecodcola'])) ? $this->New_label['cdatecodcola'] : "FECHA";
 $nmgp_tab_label .= "cdatecodcola?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_cdatecodcola_dia" name="cdatecodcola_dia" value="<?php echo NM_encode_input($cdatecodcola_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.cdatecodcola_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_cdatecodcola_mes" name="cdatecodcola_mes" value="<?php echo NM_encode_input($cdatecodcola_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.cdatecodcola_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_cdatecodcola_ano" name="cdatecodcola_ano" value="<?php echo NM_encode_input($cdatecodcola_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<INPUT type="hidden" id="sc_cdatecodcola_jq">
        <SPAN id="id_css_cdatecodcola"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_cdatecodcola"  <?php echo $str_display_cdatecodcola; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_cdatecodcola_input_2_dia" name="cdatecodcola_input_2_dia" value="<?php echo NM_encode_input($cdatecodcola_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.cdatecodcola_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_cdatecodcola_input_2_mes" name="cdatecodcola_input_2_mes" value="<?php echo NM_encode_input($cdatecodcola_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.cdatecodcola_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_cdatecodcola_input_2_ano" name="cdatecodcola_input_2_ano" value="<?php echo NM_encode_input($cdatecodcola_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
         <INPUT type="hidden" id="sc_cdatecodcola_jq2">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['oficodcola'])) ? $this->New_label['oficodcola'] : "OFICINA"; ?></TD>
      
      <INPUT type="hidden" id="SC_oficodcola_cond" name="oficodcola_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_oficodcola" <?php echo $str_hide_oficodcola?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['oficodcola'])) ? $this->New_label['oficodcola'] : "OFICINA";
 $nmgp_tab_label .= "oficodcola?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $oficodcola_look = substr($this->Db->qstr($oficodcola), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT OFICOD, OFIDES  FROM PRDCOLA.CEMPRES1  ORDER BY OFIDES"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['psq_check_ret']['oficodcola'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['psq_check_ret']['oficodcola'][] = trim($rs->fields[0]);
      ...
      echo "<span id=\"idAjaxCheckbox_oficodcola\">\r\n";
      echo "        <TABLE border=\"0px\" cellpadding=\"0px\">\r\n";
      echo "         <TR>\r\n";
      if (!isset($oficodcola) || !is_array($oficodcola))
      {
         $oficodcola = array();
      }
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            echo "           <INPUT class=\"scFilterObjectEven\" type=\"checkbox\" id=\"SC_oficodcola\" name=\"oficodcola[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
     ...
     echo "         <TR>\r\n";
     echo "          <TD colspan=2>\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_all.gif\" ALIGN=\"absmiddle\" onClick=\"nm_marca_check('oficodcola', 'N'); return false;\" style=\"cursor: pointer\">&nbsp;\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_none.gif\" ALIGN=\"absmiddle\" onClick=\"nm_limpa_check('oficodcola', 'N'); return false;\" style=\"cursor: pointer\">\r\n";
     echo "         </TR>\r\n";
      echo "        </TABLE>\r\n";
      echo "</span>\r\n";
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['mvtnabr'])) ? $this->New_label['mvtnabr'] : "MVTNABR"; ?></TD>
      
      <INPUT type="hidden" id="SC_mvtnabr_cond" name="mvtnabr_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_mvtnabr" <?php echo $str_hide_mvtnabr?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['mvtnabr'])) ? $this->New_label['mvtnabr'] : "MVTNABR";
 $nmgp_tab_label .= "mvtnabr?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $mvtnabr_look = substr($this->Db->qstr($mvtnabr), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct MVTNABR from " . $this->Ini->nm_tabela . " where MVTNABR = '$mvtnabr_look'"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
      ...
      if (isset($nmgp_def_dados[0][$mvtnabr]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$mvtnabr];
      }
      else
      {
          $sAutocompValue = $mvtnabr;
      }
?>
<INPUT  type="text" id="SC_mvtnabr" name="mvtnabr" value="<?php echo NM_encode_input($mvtnabr) ?>" size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_mvtnabr" name="mvtnabr_autocomp" size="40" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
 ...
 <TR align="center">
  <TD class="scFilterTableTd">
   <table width="100%" class="scFilterToolbar"><tr>
    ...
    <td class="scFilterToolbarPadding" align="center" width="33%" nowrap>
   <?php echo nmButtonOutput($this->arr_buttons, "bpesquisa", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200)", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200)", "sc_b_pesq_bot", "", "Consultar", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "" . $this->Ini->Nm_lang['nmgp_lang_btns_srch_lone_hint'] . "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
?>
<?php
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['opc_psq'] && !$this->aba_iframe))
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_cdatecodcola'), document.F1.cdatecodcola_cond, 'cdatecodcola');
   document.F1.cdatecodcola_dia.value = "";
   document.F1.cdatecodcola_mes.value = "";
   document.F1.cdatecodcola_ano.value = "";
   document.F1.cdatecodcola_input_2_dia.value = "";
   document.F1.cdatecodcola_input_2_mes.value = "";
   document.F1.cdatecodcola_input_2_ano.value = "";
   nm_campos_between(document.getElementById('id_vis_oficodcola'), document.F1.oficodcola_cond, 'oficodcola');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'oficodcola[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   nm_campos_between(document.getElementById('id_vis_mvtnabr'), document.F1.mvtnabr_cond, 'mvtnabr');
   document.F1.mvtnabr.value = "";
   document.F1.mvtnabr_autocomp.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_cdatecodcola_dia').bind('change', function() {sc_grid_PRDCOLA_ESTADISTICA_TICKETS_valida_dia(this)});
    $('#SC_cdatecodcola_input_2_dia').bind('change', function() {sc_grid_PRDCOLA_ESTADISTICA_TICKETS_valida_dia(this)});
    $('#SC_cdatecodcola_input_2_mes').bind('change', function() {sc_grid_PRDCOLA_ESTADISTICA_TICKETS_valida_mes(this)});
    $('#SC_cdatecodcola_mes').bind('change', function() {sc_grid_PRDCOLA_ESTADISTICA_TICKETS_valida_mes(this)});
 }
 function sc_grid_PRDCOLA_ESTADISTICA_TICKETS_valida_dia(obj)
 {
 ...
 function sc_grid_PRDCOLA_ESTADISTICA_TICKETS_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "estadistico_colas/grid_PRDCOLA_ESTADISTICA_TICKETS";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "estadistico_colas/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
          $NM_patch .= "grid_PRDCOLA_ESTADISTICA_TICKETS/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_cdatecodcola_cond'] = 'cond';
      $tp_fields['SC_cdatecodcola_dia'] = 'text';
      $tp_fields['SC_cdatecodcola_mes'] = 'text';
      $tp_fields['SC_cdatecodcola_ano'] = 'text';
      $tp_fields['SC_cdatecodcola_input_2_dia'] = 'text';
      $tp_fields['SC_cdatecodcola_input_2_mes'] = 'text';
      $tp_fields['SC_cdatecodcola_input_2_ano'] = 'text';
      $tp_fields['SC_oficodcola_cond'] = 'cond';
      $tp_fields['SC_oficodcola'] = 'checkbox';
      $tp_fields['SC_mvtnabr_cond'] = 'cond';
      $tp_fields['SC_mvtnabr'] = 'text_aut';
      $tp_fields['id_ac_mvtnabr'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $cdatecodcola_cond, $cdatecodcola, $cdatecodcola_dia, $cdatecodcola_mes, $cdatecodcola_ano, $cdatecodcola_input_2_dia, $cdatecodcola_input_2_mes, $cdatecodcola_input_2_ano,
             $oficodcola_cond, $oficodcola,
             $mvtnabr_cond, $mvtnabr, $mvtnabr_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($mvtnabr_autocomp) && empty($mvtnabr))
      {
          $mvtnabr = $mvtnabr_autocomp;
      }
      $cdatecodcola_cond_salva = $cdatecodcola_cond; 
      if (!isset($cdatecodcola_input_2_dia) || $cdatecodcola_input_2_dia == "")
      {
          $cdatecodcola_input_2_dia = $cdatecodcola_dia;
      }
      if (!isset($cdatecodcola_input_2_mes) || $cdatecodcola_input_2_mes == "")
      {
          $cdatecodcola_input_2_mes = $cdatecodcola_mes;
      }
      if (!isset($cdatecodcola_input_2_ano) || $cdatecodcola_input_2_ano == "")
      {
          $cdatecodcola_input_2_ano = $cdatecodcola_ano;
      }
      $oficodcola_cond_salva = $oficodcola_cond; 
      if (!isset($oficodcola_input_2) || $oficodcola_input_2 == "")
      {
          $oficodcola_input_2 = $oficodcola;
      }
      $mvtnabr_cond_salva = $mvtnabr_cond; 
      if (!isset($mvtnabr_input_2) || $mvtnabr_input_2 == "")
      {
          $mvtnabr_input_2 = $mvtnabr;
      }
      if ($cdatecodcola_cond != "nu" && $cdatecodcola_cond != "nn" && $cdatecodcola_cond != "ep" && $cdatecodcola_cond != "ne")
      {
          if ($cdatecodcola_dia == "" && $cdatecodcola_mes == "" && $cdatecodcola_ano == "")
          {
              if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "FECHA : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          }
      }
      if (is_array($oficodcola)) {
          foreach ($oficodcola as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['psq_check_ret']['oficodcola'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "OFICINA : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_dia'] = $cdatecodcola_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_mes'] = $cdatecodcola_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_ano'] = $cdatecodcola_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_input_2_dia'] = $cdatecodcola_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_input_2_mes'] = $cdatecodcola_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_input_2_ano'] = $cdatecodcola_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_cond'] = $cdatecodcola_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['oficodcola'] = $oficodcola; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['oficodcola_cond'] = $oficodcola_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['mvtnabr'] = $mvtnabr; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['mvtnabr_cond'] = $mvtnabr_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['oficodcola'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['oficodcola'];
      $this->cmp_formatado['oficodcola_input_2'] = $oficodcola_input_2;
      $mvtnabr_look = substr($this->Db->qstr($mvtnabr), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct MVTNABR from " . $this->Ini->nm_tabela . " where MVTNABR = '$mvtnabr_look'"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['mvtnabr'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['mvtnabr'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['mvtnabr'] = $mvtnabr;
      }

      //----- $cdatecodcola
      $this->Date_part = false;
      if ($cdatecodcola_cond != "TP")
      {
          $cdatecodcola_cond = strtoupper($cdatecodcola_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $cdatecodcola_ano;
          $Dtxt .= $cdatecodcola_mes;
          $Dtxt .= $cdatecodcola_dia;
          $val[0]['ano'] = $cdatecodcola_ano;
          $val[0]['mes'] = $cdatecodcola_mes;
          $val[0]['dia'] = $cdatecodcola_dia;
          if ($cdatecodcola_cond == "BW")
          {
              $val[1]['ano'] = $cdatecodcola_input_2_ano;
              $val[1]['mes'] = $cdatecodcola_input_2_mes;
              $val[1]['dia'] = $cdatecodcola_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $cdatecodcola_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $cdatecodcola_cond , "", "data");
          }
          $cdatecodcola = $val[0];
          $this->cmp_formatado['cdatecodcola'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['cdatecodcola'], "YYYY-MM-DD");
          $this->cmp_formatado['cdatecodcola'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($cdatecodcola_cond == "BW")
          {
              $cdatecodcola_input_2     = $val[1];
              $this->cmp_formatado['cdatecodcola_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']['cdatecodcola_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['cdatecodcola_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['cdatecodcola_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $cdatecodcola_cond == "NU" || $cdatecodcola_cond == "NN"|| $cdatecodcola_cond == "EP"|| $cdatecodcola_cond == "NE")
          {
              $this->monta_condicao("CDATECODCOLA", $cdatecodcola_cond, $cdatecodcola, $cdatecodcola_input_2, 'cdatecodcola', 'DATE');
          }
      }

      //----- $oficodcola
      $this->Date_part = false;
      $oficodcola = $oficodcola; 
      $nm_aspas = "";
      if (count($oficodcola) != 0)
      {
         foreach ($oficodcola as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if (strtoupper($oficodcola_cond) == "DF" || strtoupper($oficodcola_cond) == "NP")
         {
             $this->comando        .= " OFICODCOLA not in (";
             $this->comando_sum    .= " PRDCOLA.ESTADISTICA_TICKETS.OFICODCOLA not in (";
             $this->comando_filtro .= " OFICODCOLA not in (";
         }
         else
         {
             $this->comando        .= " OFICODCOLA in (";
             $this->comando_sum    .= " PRDCOLA.ESTADISTICA_TICKETS.OFICODCOLA in (";
             $this->comando_filtro .= " OFICODCOLA in (";
         }
         $x                     = count($oficodcola);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $nmgp_tab_label['oficodcola'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }

      //----- $mvtnabr
      $this->Date_part = false;
      if (isset($mvtnabr) || $mvtnabr_cond == "nu" || $mvtnabr_cond == "nn" || $mvtnabr_cond == "ep" || $mvtnabr_cond == "ne")
      {
         $this->monta_condicao("MVTNABR", $mvtnabr_cond, $mvtnabr, "", "mvtnabr");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_PRDCOLA_ESTADISTICA_TICKETS']['fast_search']);
