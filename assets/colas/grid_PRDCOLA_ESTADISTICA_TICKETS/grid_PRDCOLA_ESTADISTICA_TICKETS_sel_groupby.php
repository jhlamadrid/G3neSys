<?php
   ...
   $Sel_Groupby = new grid_PRDCOLA_ESTADISTICA_TICKETS_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_PRDCOLA_ESTADISTICA_TICKETS_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_tabular']);
       if ($sel_groupby == "sc_free_group_by")
       {
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['oficodcola'] = array('cmp' => "OFICODCOLA", 'ind' => 0);
           $tab_arr_groubby_cmp['cdatecodcola'] = array('cmp' => "CDATECODCOLA", 'ind' => 1);
           $tab_arr_groubby_cmp['tickabr'] = array('cmp' => "TICKABR", 'ind' => 2);
           $tab_arr_groubby_cmp['usrcodcola'] = array('cmp' => "USRCODCOLA", 'ind' => 3);
           $tab_arr_groubby_sql[0] = array('cmp' => "OFICODCOLA", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "CDATECODCOLA", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "TICKABR", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "USRCODCOLA", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_sql'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_sql'][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
               }
           }
       }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo")
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_display'] as $i_sum => $d_sum)
       {
           $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_display'][$i_sum]['display'] = in_array($i_sum, $summ_fields);
       }
       $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_order'] = $summ_fields;
   }
?>
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['oficodcola']  = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']['oficodcola'])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']['oficodcola'] : "OFICINA";
   $arr_campos_free['cdatecodcola']  = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']['cdatecodcola'])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']['cdatecodcola'] : "FECHA";
   $arr_campos_free['tickabr']  = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']['tickabr'])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']['tickabr'] : "TIPO TICKET";
   $arr_campos_free['usrcodcola']  = (isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']['usrcodcola'])) ? $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['labels']['usrcodcola'] : "Usuario";
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_PRDCOLA_ESTADISTICA_TICKETS_sel_groupby.php",
    data: {
...
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_control'] as $l_field => $d_field)
    {
...
{
?>
   $("#sc_id_summ_available").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_display']) * 29 ?>px");
   $("#sc_id_summ_selected").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_display']) * 29 ?>px");
<?php
}
?>
  }
...
<?php
    ...
    $iTabCount            = 1;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Groupby_hide']))
        {
...
?>
 <tr id="sc_id_static_groupby">
  <td>
<?php
     if (!in_array("mes1", $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "mes1")
        {
            $check = " checked";
            $bStartFree = false;
        }
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="mes1" id="sc_id_sel_groupby_mes1"<?php echo $check ?> /><label for="sc_id_sel_groupby_mes1" style="font-weight: bold">Mes</label>
      <br />
      <span style="padding-left: 30px">FECHA</span>
      <br /><br />
<?php
     }
?>
 ...
 <tr id="sc_id_free_groupby">
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Groupby_hide']))
     {
...
<?php
        ...
        foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp'] as $NM_cada_field => $resto)
        {
        ...
        if ($bSummaryPage)
        {
            ...
            foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['pivot_x_axys'] as $temp)
            {
                reset($aTmpGroupBy);
...
<?php
        ...
        {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['SC_Gb_Free_cmp'][$NM_cada_field]))
           {
?>
...
<?php
        foreach ($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_order'] as $i_sum)
        {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_display'][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['grid_PRDCOLA_ESTADISTICA_TICKETS']['summarizing_fields_display'][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
